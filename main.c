...
// Global Variables
char input_string[25];       // Buffer to store user input command
char prompt[25] = "msh$";  // Default shell prompt
char* external_command[200] = {NULL};  // Array to store external commands
int main()
{
    system("clear");  // Clear the terminal screen before starting the shell
    scan_input(prompt, input_string);  // Call function to take user input
